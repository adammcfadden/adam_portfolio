...
describe Project do
  ...
  it 'will summarize a description of text over 100 char' do
    project = FactoryGirl.create(:project, description: "Wes Anderson dreamcatcher occupy Echo Park, vinyl freegan flannel you probably haven't heard of them +1 American Apparel. Cornhole street art seitan lomo Kickstarter.")
  ...
  it 'will return description if under 100 char' do
    project = FactoryGirl.create(:project, description: "asserting that an attribute")
